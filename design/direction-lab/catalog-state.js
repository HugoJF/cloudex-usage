...
function series(values) {
    return Object.freeze(values.split(',').map(Number));
}

export const HISTORY = Object.freeze({
    claudeShort: series('2,2,2,7,7,7,11,11,13,13,13,16,18,21,23,24,26,' +
        '27,29,29,31,31,34,36,4,7,8,8,8,8'),
    claudeWeekly: series('61,61,62,62,62,63,63,63,63,64,64,64,64,64,65,' +
        '65,65,65,66,66,66,66,67,67,67,67,68,68,68,68'),
    codexWeekly: series('27,27,28,28,29,30,30,31,31,32,33,34,34,35,36,' +
